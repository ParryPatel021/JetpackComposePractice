package com.softcoderdev.compose_practice
...
import com.softcoderdev.compose_practice.ui.theme.JetpackComposePraciceTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            JetpackComposePraciceTheme {
        ...
        IconButton(onClick = { expanded = !expanded }) {
            Icon(
                ...
                contentDescription = if (expanded) stringResource(
                    id = R.string.show_less) else stringResource(
